...
!-----------------------------------------------------------------------
    ...
    str = get_filename(mksrf_sectorWater)
    call check_ret(nf_put_att_text(ncid, NF_GLOBAL, &
    ...
    str = get_filename(map_sectorWater)
    call check_ret(nf_put_att_text(ncid, NF_GLOBAL, &
