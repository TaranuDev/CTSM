module clm_cpl_indices
   ...
   integer, public ::index_l2x_Flrl_dom_withd   ! domestic usage withdrawal
   integer, public ::index_l2x_Flrl_dom_rf      ! domestic usage return flow
   integer, public ::index_l2x_Flrl_liv_withd   ! livestock usage withdrawal
   integer, public ::index_l2x_Flrl_liv_rf      ! livestock usage return flow
   integer, public ::index_l2x_Flrl_elec_withd  ! thermoelectric usage withdrawal
   integer, public ::index_l2x_Flrl_elec_rf     ! thermoelectric usage return flow
   integer, public ::index_l2x_Flrl_mfc_withd   ! manufacturing usage withdrawal
   integer, public ::index_l2x_Flrl_mfc_rf      ! manufacturing usage return flow
   integer, public ::index_l2x_Flrl_min_withd   ! mining usage withdrawal
   integer, public ::index_l2x_Flrl_min_rf      ! mining usage return flow
 ...
 contains
   ...
   subroutine clm_cpl_indices_set( )
     ...
     index_l2x_Flrl_lec_rf   = mct_avect_indexra(l2x,'Flrl_elec_rf')
